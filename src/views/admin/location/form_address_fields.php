<ul>
    <li>
        <div class="js-wpt-field wpt-field js-wpt-textfield wpt-textfield">
            <div class="form-item form-item-textfield">
                <label class="wpt-form-label" for="address_line1">Line 1</label>
    ...
    <li>
        <div class="js-wpt-field wpt-field js-wpt-textfield wpt-textfield">
            <div class="form-item form-item-textfield">
                <label class="wpt-form-label" for="address_line2">Line 2</label>
    ...
    <li>
        <div class="js-wpt-field wpt-field js-wpt-textfield wpt-textfield">
            <div class="form-item form-item-textfield">
                <label class="wpt-form-label" for="address_lat">Latitude</label>
                <input type="text"
    ...
    <li>
        <div class="js-wpt-field wpt-field js-wpt-textfield wpt-textfield">
            <div class="form-item form-item-textfield">
                <label class="wpt-form-label" for="address_lon">Longitude</label>
